...
<div class="w3-content w3-container w3-padding-64" id="about">
  ...
  <p class="w3-center"><em>I love pragramming</em></p>
  <p><div class="w3-row">
    <div class="w3-col m6 w3-center w3-padding-large">
      <p><b><i class="fa fa-user w3-margin-right"></i>Mukesh Dangi</b></p><br>
  ...
  <p class="w3-wide"><i class="fa fa-laptop"></i>Software Development</p>
  <div class="w3-light-grey">
    <div class="w3-container w3-padding-small w3-dark-grey w3-center" style="width:85%">85%</div>
  </div>
  <p class="w3-wide"><i class="fa fa-photo"></i>Architecture</p>
  <div class="w3-light-grey">
